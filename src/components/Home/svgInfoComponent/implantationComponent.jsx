...
import ImplantationModal from './modalInComponent/implantationModal';

const ImplantationComponent = () => {
    ...
    return (
        <>
            ...
            <div class="m-2 group basis-1/2">
                <div class="ring-2 ring-blue-500/50 p-6 rounded-md shadow-lg hover:bg-my text-center">
                    ...
                    <h2 class="text-lg text-gray-900 font-semibold title-font mb-2 group-hover:text-white">Импланты</h2>
                    <button onClick={() => {
                        setModalActive(true)
...
export default ImplantationComponent;
